...
<tbody>
<?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voc): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($voc["company_name"]); ?></td><td><button class="modify" url="__URL__/ModifyCompany?company_id=<?php echo ($voc["company_id"]); ?>">修改</button>&nbsp;&nbsp;<button  class="deletebasic" url="__URL__/DeleteCompany?company_id=<?php echo ($voc["company_id"]); ?>">删除</button></td>
</tr><?php endforeach; endif; else: echo "" ;endif; ?>
<form method="POST" action="__URL__/AddCompany">
<tr><td>
公司全称:<input type="text" name="company_name" /><br />
公司简称:<input type="text" name="company_snm" /><br />
