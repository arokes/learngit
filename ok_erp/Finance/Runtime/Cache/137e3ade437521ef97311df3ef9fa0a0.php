...
<?php if(is_array($mekacompany_data)): $i = 0; $__LIST__ = $mekacompany_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["mekacompany"]); ?>"><?php echo ($vo["mekacompany"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select>
<label>购方公司名称：</label>
