...
<center>
<font>查询美科缴库单数据列表</font><br />
<font><?php echo ($date_min); ?>---<?php echo ($date_max); ?></font>
<table id="table-4">
<thead>
<th>批号</th><th>品号</th><th>品名</th><th>缴库数量</th>
</thead>
<tbody>
<?php if(is_array($mekamm_list)): $i = 0; $__LIST__ = $mekamm_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($vo["bat_no"]); ?></td><td><a href="FindWarehouseAccountSum?bat_no=<?php echo (urlencode($vo["bat_no"])); ?>&prd_no=<?php echo ($vo["prd_no"]); ?>"><?php echo ($vo["prd_no"]); ?></a></td><td ><?php echo (iconv("GBK","utf-8",$vo["name"])); ?></td><td><?php echo ($vo["qty"]); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
</tbody>
