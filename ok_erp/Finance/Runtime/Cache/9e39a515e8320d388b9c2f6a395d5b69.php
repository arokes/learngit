...
<div class="newexchangebig">
<div class="newexchange">
<form method="post" action="__URL__/DeleteExchangeResult">
<input type="hidden" name="id" value="<?php echo ($data["0"]["id"]); ?>" />
<input type="hidden" name="claim" value="9" />
<div class="bill_box_font">
销售方式:<br />
公司:<br />
银行:<br />
到款日期:<br />
...
<div class="bill_box_input">
<?php echo ($data["0"]["foreign_trade"]); ?><br />
<?php echo ($data["0"]["company_name"]); ?><br />
<?php echo ($data["0"]["bank_name"]); ?><br />
<?php echo ($data["0"]["pay_dd"]); ?><br />
<?php echo ($data["0"]["bank_cust"]); ?><br />
<?php echo ($data["0"]["country"]); ?><br />
<?php echo ($data["0"]["CUR_ID"]); ?><br />
<?php echo ($data["0"]["amount"]); ?><br />
</div>
<center>
<input type="submit" value="删除" /></center>
</form>
</div>
</div>
