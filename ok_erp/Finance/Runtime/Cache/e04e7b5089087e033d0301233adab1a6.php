...
<table id="table-5">
<thead>
<th>销售方式</th><th>公司</th><th>银行</th><th>到款日期</th><th>汇款人名字</th><th>汇款人国家</th><th>币别</th><th>到账金额</th>
</thead>
<tbody>
<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($vo["foreign_trade"]); ?></td><td><?php echo ($vo["company_name"]); ?></td><td><?php echo ($vo["bank_name"]); ?></td><td><?php echo ($vo["pay_dd"]); ?></td><td><?php echo ($vo["bank_cust"]); ?></td><td><?php echo ($vo["country"]); ?></td><td><?php echo ($vo["CUR_ID"]); ?></td><td><?php echo ($vo["amount"]); ?></td><td><a target="_blank"  href="ModifyExchangeDetail?id=<?php echo ($vo["id"]); ?>">修改</a></td><td><a class="deletebasic" url="__URL__/DeleteExchangeResult?id=<?php echo ($vo["id"]); ?>">删除</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
