...
<center>
	<font><?php echo ($factory_name); ?>--未记账开票明细</font><br />
	开票单号:<b><?php echo ($list_mf[0]['lz_no']); ?></b>&nbsp;&nbsp;开票日期:<b><?php echo ($list_mf[0]['lz_dd']); ?></b>&nbsp;&nbsp; 发票号码:<b><?php echo (iconv("GBK","utf-8",$list_mf[0]['inv_no'])); ?></b> <br />
	总金额:<b><?php echo ($list_mf[0]['amtn_net']); ?></b>&nbsp;&nbsp;凭证号:<b><?php echo ($list_mf[0]['voh_no']); ?></b>&nbsp;&nbsp;制单人:<b><?php echo ($list_mf[0]['usr']); ?></b><br />
	客户名称:<b><?php echo (iconv("GBK","utf-8",$list_mf[0]['name'])); ?></b>&nbsp;&nbsp;备注:<b><?php echo (iconv("GBK","utf-8",$list_mf[0]['rem'])); ?></b><br />                  
...
<tbody>
	<?php $sum_qty=0;$sum_amtn=0; ?>
<?php if(is_array($list_tf)): $i = 0; $__LIST__ = $list_tf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo (iconv("GBK","utf-8",$vo["lz_no"])); ?></td>
<td><?php echo ($vo["ck_no"]); ?></td>
...
<td><?php $sum_qty=$sum_qty+$vo['qty']; echo ($vo["qty"]); ?></td>
<td><?php $sum_amtn=$sum_amtn+$vo['amtn_net']; echo ($vo["amtn_net"]); ?></td>
</tr><?php endforeach; endif; else: echo "" ;endif; ?>
<tr><td>合计</td><td></td><td></td><td></td><td></td><td><?php echo ($sum_qty); ?></td><td><?php echo ($sum_amtn); ?></td></tr>
</tbody>
</table>
</volist>
