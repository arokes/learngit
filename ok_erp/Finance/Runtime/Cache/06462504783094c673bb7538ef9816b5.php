...
<tbody>
<?php if(is_array($listmf)): $i = 0; $__LIST__ = $listmf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($vo["foreign_trade"]); ?></td><td><?php echo ($vo["company_name"]); ?></td><td><?php echo ($vo["bank_name"]); ?></td><td><?php echo ($vo["pay_dd"]); ?></td><td><?php echo ($vo["bank_cust"]); ?></td><td><?php echo ($vo["country"]); ?></td><td><?php echo ($vo["CUR_ID"]); ?></td><td><?php echo ($vo["amount"]); ?></td><td><a target="_blank" href="__URL__/ModifyExchangeDetail?id=<?php echo ($vo["id"]); ?>">修改</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
</tbody>
</table>
<?php echo ($show); ?><br />
