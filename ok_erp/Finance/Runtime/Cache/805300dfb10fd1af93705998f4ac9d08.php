...
<tbody>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><?php echo ($vo["cust_name"]); ?></td><td><?php echo ($vo["country"]); ?></td><td><a href="__URL__/SelectAccountDetail?so_id=<?php echo ($vo["so_id"]); ?>"><?php echo ($vo["so_no"]); ?></a></td><td><?php echo ($vo["CUR_ID"]); ?></td><td><?php echo ($vo["HONGKONG_PI"]); ?></td>
