...
<table id="table-5">
<thead><th>编号</th><th>销售方式</th><th>公司</th><th>银行</th><th>付款日期</th><th>汇款客户</th><th>汇款国家</th><th>币别</th><th>总到账金额</th><th>业务员</th><th>订单到账金额</th><th>手续费</th><th>订单号</th><th>订单PI总金额</th><th>合同客户</th></thead>
<tbody>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><a href="__URL__/selectClaimDetail?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["id"]); ?></a></td><td><?php echo ($vo["foreign_trade"]); ?></td><td><?php echo ($vo["company_snm"]); ?></td><td><?php echo ($vo["bank_snm"]); ?></td><td><?php echo ($vo["pay_dd"]); ?></td><td><?php echo ($vo["bank_cust"]); ?></td><td><?php echo ($vo["country"]); ?></td><td><?php echo ($vo["CUR_ID"]); ?></td><td><?php echo ($vo["amount"]); ?></td><td><?php echo ($vo["sal_name"]); ?></td><td><?php echo ($vo["amount_apart"]); ?></td><td><?php echo ($vo["brokerage"]); ?></td><td><a href="__URL__/../Account/SelectAccountDetail?so_id=<?php echo ($vo["so_id"]); ?>"><?php echo ($vo["so_no"]); ?></a></td><td><?php echo ($vo["so_pi"]); ?></td><td><?php echo ($vo["contract_cust"]); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
</tbody>
</table>
