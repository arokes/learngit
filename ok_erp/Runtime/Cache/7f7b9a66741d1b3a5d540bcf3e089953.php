...
<label>客户名称:</label>
<input type="text" name="cust_name" value="<?php echo ($account["cust_name"]); ?>"  />
<label>国家:</label>
<input type="text" name="country" value="<?php echo ($account["country"]); ?>" />
<label>订单号:</label>
<input type="text" name="so_no" value="<?php echo ($account["so_no"]); ?>" />
<label>币别:</label>
<select name="CUR_ID">
...
<input type="text" placeholder="与香港公司的订单金额" value="<?php echo ($account["HONGKONG_PI"]); ?>" name="HONGKONG_PI"  />
<label>与国内公司PI金额:</label>
<input type="text" placeholder="与国内公司的订单金额" value="<?php echo ($account["CHINA_PI"]); ?>" name="CHINA_PI"  />
<label>预计出货时间:</label>
...
<label>应收款:</label>
<input type="text" placeholder="该订单需要收款的总金额" name="receivable" value="<?php echo ($account["receivable"]); ?>"  />
<label>账期:</label>
<input type="text" placeholder="发货XX天后付款" name="account_period" value="<?php echo ($account["account_period"]); ?>" />
<label>应收款日期:</label>
...
<label>业务员:</label>
<input type="text" placeholder="业务员名称" name="sal_name" value="<?php echo ($account["sal_name"]); ?>"  />
<label>备注:</label>
