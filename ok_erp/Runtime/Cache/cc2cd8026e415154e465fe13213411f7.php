...
<h3>查询时间:<?php echo ($title_name); ?></h3>
<table id="table-5">
<thead><th>编号</th><th>销售方式</th><th>公司</th><th>银行</th><th>付款日期</th><th>汇款客户</th><th>汇款国家</th><th>币别</th><th>到账金额</th><th>业务员</th><th>认领金额</th><th>手续费</th><th width="150px">订单号</th><th>订单PI总金额</th></thead>
<tbody>
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><a target="_blank" href="__URL__/selectClaimDetail?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["id"]); ?></a></td><td><?php echo ($vo["foreign_trade"]); ?></td><td><?php echo ($vo["company_snm"]); ?></td><td><?php echo ($vo["bank_snm"]); ?></td><td><?php echo ($vo["pay_dd"]); ?></td><td><?php echo ($vo["bank_cust"]); ?></td><td><?php echo ($vo["country"]); ?></td><td><?php echo ($vo["CUR_ID"]); ?></td><td><?php echo ($vo["amount"]); ?></td><td><?php echo ($vo["sal_name"]); ?></td><td><?php echo ($vo["amount_apart"]); ?></td><td><?php echo ($vo["brokerage"]); ?></td><td width="150px"><a target="_blank" href="__URL__/../Account/SelectAccountDetail?so_id=<?php echo ($vo["so_id"]); ?>"><?php echo ($vo["so_no"]); ?></a></td><td><?php echo ($vo["so_pi"]); ?></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
</tbody>
</table>
<div class="result page"><?php echo ($page); ?></div><br />
<button type="button" onclick="javascript:history.back(-1)">返回</button><br />
