...
<font>到款信息</font>
<table id="table-5">
<thead><th>编号</th><th>销售方式</th><th>公司</th><th>银行</th><th>付款日期</th><th>汇款客户</th><th>汇款国家</th><th>币别</th><th>到账金额</th><th>业务</th><th>跟单</th><thead>
<tbody>
...
<table id="table-5">
<thead>
<th>到账金额</th><th>手续费</th><th>订单号</th><th>订单PI总金额</th><th>是否报关</th><th>合同客户</th><th>开票客户</th><th>联系客户</th><th>罚款/扣款</th><th>备注</th><th>核销</th><th></th></thead>
<tbody>
<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
<td><?php echo ($vo["amount_apart"]); ?></td><td><?php echo ($vo["brokerage"]); ?></td><td><?php echo ($vo["so_no"]); ?></a></td><td><?php echo ($vo["so_pi"]); ?></td><td><?php echo ($vo["is_declare"]); ?></td><td><?php echo ($vo["contract_cust"]); ?></td><td><?php echo ($vo["lz_cust"]); ?></td><td><?php echo ($vo["connect_cust"]); ?></td><td><?php echo ($vo["debit"]); ?></td><td><?php echo ($vo["rem"]); ?></td><td><?php echo ($vo["cls_id"]); ?></td><td><a target="_blank" href="../Account/SelectAccountDetail?so_id=<?php echo ($vo["so_id"]); ?>">查看台账</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?>
</tbody>
</table>
<a href="changeClaim?id=<?php echo ($data["0"]["id"]); ?>">修改认领金额</a>
<a href=<?php echo ($url_bak); ?>>返回</a>
<a href="deleteClaim?id=<?php echo ($data["0"]["id"]); ?>">删除认领信息</a>
<br />
